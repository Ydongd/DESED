...
def get_args_parser():
    ...
    parser = argparse.ArgumentParser(description="Command line interface for DESED.")
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Select the model type selected to be used from bert, roberta, albert."
    )
    ...
    parser.add_argument("--num_sentence", type=int, default=1, help="Number of sentences to use.")
